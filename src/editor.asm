...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	CSEG
	PUBLIC	EDITOR
	EXTRN  	DRAWREGION,PATTERN,TILE,DELSPR,SETPAGE,SPRITE,COLORSPRITE,EXIT
EDITOR:
	LD	C,TILEPAT
	LD	DE,TILEGEN
...
;INPUT:	(PATTERN) = ACTUAL SELECTED PATTERN
	...
	CSEG
	EXTRN	PATTERN,TILE2XY,GETCHAR,PUTSPRITE
...
;		(TILE) = ACTUAL TILE
	...
	CSEG
	EXTRN	TILEINC,MARKREGION,GETCHAR,VDPSYNC
