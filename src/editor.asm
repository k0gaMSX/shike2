...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CSEG
	PUBLIC	ED.INFO
	EXTRN	DELSPR,CLRVPAGE,LOCATE

ED.INFO:CALL	DELSPR
	LD	E,TILPAGE		;CLEAR THE SCREEN
	CALL	CLRVPAGE
	LD	DE,ERRORCOORD
	JP	LOCATE			;LOCATE THE CURSOR IN THE BEGINNING

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

	CSEG
	PUBLIC	ED.ERROR,ERRSTR
	EXTRN	PERROR,KPRESS,VDPSYNC

ED.ERROR:
	CALL	ED.INFO
	CALL	PERROR
	CALL	VDPSYNC
	JP	KPRESS			;WAIT A KEY

ERRSTR:	DW	E.MSG1,E.MSG2,E.MSG3
E.MSG1:	DB	"TOO MUCH PATTERNS IN THIS TILE POSITION",0
E.MSG2:	DB	"NEW PATTERN HAS SMALLER Z THAN PREVIOUS",0
E.MSG3:	DB	"NO ENOUGH MEMORY IN BUFFER",0
