...
;INPUT:	(PATTERN) = ACTUAL SELECTED PATTERN
	...
	CSEG
	EXTRN	KPRESS,METAPAT,DELSPR,SETPAGE,PATTERN
...
;		(TILE) = ACTUAL TILE
	...
	CSEG
	EXTRN	KEVENT,SETPAGE,DELSPR,TILEINC,MARKREGION,VDPSYNC
...
;INPUT:		(TILE) = ACTUAL TILE SELECTED
	...
	CSEG
	EXTRN	KEVENT,DELSPR,SETPAGE,TILE,KEY2DIR,MOVISO,MOVEUC
