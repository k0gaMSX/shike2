...
ZBUFFERROW	EQU	NR_SCRCOL*NR_PATTIL*2
ZBUFFERSIZ	EQU	NR_SCRROW*ZBUFFERROW
...
DR.VEC:	DW	DXYREGION,DXZREGION,DYZREGION,DXZREGION_,DYZREGION_,DISOTILE
MR.VEC:	DW	MXYREGION,MXZREGION,MYZREGION,MXZREGION_,MYZREGION_,MISOTILE
...
RESETMAP:
	...
	LD	(ZVALUE),A
	LD	HL,ZBUFFER
	LD	BC,NR_SCRROW*NR_SCRCOL*NR_PATTIL*2
	JP	MEMSET
...
ADDRZVAL:
	...
	ADD	HL,HL
	ADD	HL,HL
	ADD	HL,HL		;HL = NR_SCRCOL * 4 * 2 * Y -> Y OFFSET
	PUSH	HL
	LD	L,D
	LD	H,0
	ADD	HL,HL		;HL = 2 * X
	ADD	HL,HL
	ADD	HL,HL		;HL = 4 * 2 * X -> X OFFSET
	POP	DE		;DE = Y OFFSET
...
SETZVAL:CALL	ADDRZVAL	;TAKE THE DIRECTION OF THE TILE STACK
...
Y.SET:	CALL	CALZVAL		;CALCULATE THE ZVALUE
