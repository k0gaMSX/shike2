...
;	(TILEINC)
;	(METAPAT)
;OUTPUT:HL = POINTER TO OUTPUT BUFFER AFTER CHRUNCH
...
CRUNCH:	EX	DE,HL
	LD	A,(ZVALUE)		;1 BYTE: 5 BITS Z VALUE
	AND	1FH
	RLCA
	RLCA
	RLCA
	...
	LD	BC,(TILEINC)		;5,6 BYTES: TILEINC
	LD	(HL),C
	INC	HL
	LD	(HL),B
	INC	HL
...
MA.END:	LD	A,TILPAGE+1		;UPDATE THE THREE PAGES
	CALL	MA.PAG
	LD	A,BAKPAGE
MA.PAG:	LD	(ACPAGE),A
	LD	HL,0
