...
ED.FLOOR:
	CALL	EDINIT			;COMMON INITIALIZATION
...
GETFDATA:
	...
	JR	NZ,G.1
	XOR	A
	LD	(NUMPAT1),A		;FLOOR 0 DOESN'T HAVE ANY DATA
	LD	(NUMPAT2),A
	RET
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CSEG
	EXTRN	EDFLOOR,EDSET,EDPAL,DRAWSTACKS,LOCATE,PRINTF,GLINES
...
SHOWSCR:CALL	CLEANSTACK		;CLEAN THE PATTERN STACK VISUALIZATION
	...
	LD	A,(EDFLOOR)		;FLOOR 0 IS EMPTY FLOOR
	OR	A
	RET	Z
...
P.AUX:	EX	AF,AF'			;DON'T MODIFY FLOOR 0
	LD	A,(EDFLOOR)
	OR	A
	RET	Z
	EX	AF,AF'
