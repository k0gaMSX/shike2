...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CSEG
	EXTRN	GETROOM,KPRESS,PUTSPRITE,KEY2DIR,MOVEUC,PRINTF,VDPSYNC
...
ROOMINFO:
	...
	LD	DE,TEXTCOORD
	CALL	LOCATE
	LD	DE,RI.FMT		;PRINT THE ROOM NUMBER
	CALL	PRINTF
...
RI.LOOP:PUSH	BC
	...
	LD	A,(RI.ACC)
	AND	L
	CALL	NZ,PUTSPRITE		;PUT IT ONLY IF IT IS ENABLED
	POP	IY
	LD	DE,5
...
RI.DATA:DB	RIGTHSPR,PTRRPAT,M.RIGTH
	DW	RARROWCOORD
