...
DXZREGION:
	...
	LD	(XZ.TILESD),HL		;OF A YZ REGION
	LD	HL,DRAWMTILE
	LD	(XZ.TILESI),HL
	JR	XZREGION
...
MXZREGION:
	LD	HL,MARKMETATIL
	LD	(XZ.TILESU),HL		;SET ACTIONS FOR THE DIFFERENT TILES
	LD	(XZ.TILESI),HL		;OF A YZ REGION
	LD	(XZ.TILESD),HL

XZREGION:
	LD	E,-1			;PAINT TILES U
...
MYZREGION:
	LD	HL,MARKMETATIL
	LD	(YZ.TILESU),HL		;SET ACTIONS FOR THE DIFFERENT TILES
	LD	(YZ.TILESI),HL		;OF A YZ REGION
	LD	(YZ.TILESD),HL
...
;XYREGION ONLY ADMIT USUAL PATTERNS, META PATTERNS CAN CAUSE PROBLEMS
