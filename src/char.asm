...
C.CONTROL:
	...
	LD	A,(IX+CHAR.DIR)			;IS THERE A NEW DIRECTION?
	CP	D.NODIR
	RET	Z
	LD	D,(IX+CHAR.X)
	LD	E,(IX+CHAR.Y)

	LD	A,(IX+CHAR.DIR)			;TRY MOVE THE CHARACTER
	CALL	MOVEUC
...
K.SYSTEM:					;IT IS NOT A DIRECTIONAL KEY
	LD	A,(K.KEY)			;TODO: MOVE TO OTER PLACE
	CP	KB_ESC
	CALL	Z,EXIT
	RET
