...
CLIP:	LD	DE,(CLIP.X)
	...
	LD	DE,(CLIP.Y)		;TODO: FIX Y CLIPPING, BECAUSE WE ARE
	LD	BC,(CLIP.YSIZ)		;DOING IT AT 256, AND IT MUST BE DONE
	CALL	CLIP1			;AT 212 (OR MAYBE 192)
	LD	(CLIP.Y),DE
	LD	(CLIP.YSIZ),BC
	RET
...
CLIP1:	LD	L,C
	...
	BIT	0,H
	JR	NZ,C.RIGTH	;DE WAS >= 0 AND THE RESULT IS > 255
	JR	C.VIS		;DE WAS >= 0 AND THE RESULT IS <= 255
