...
MOB.Z		EQU	12	;Z VALUE IN LAST CALL TO PUTMOB

MOB.YO		EQU	13	;Y COORDENATE OF THE GRAPHIC ORIGIN
MOB.XO		EQU	14	;X COORDENATE OF THE GRAPHIC ORIGIN
MOB.SIZ		EQU	15
