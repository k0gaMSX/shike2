...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;OUTPUT:Z = 1 WHEN NO MORE FREE MOBS, 0 IN OTHER CASE
;	A = MOB NUMBER WHEN Z = 0
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CSEG
	PUBLIC	TURNOFF
	EXTRN	DISSCR,CLRVPAGE

TURNOFF:CALL	DISSCR			;DISABLE SCREEN
	LD	E,TILPAGE
	...
	LD	BC,NR_MOBS*256
T.LOOP:	PUSH	BC			;FREE ALL THE MOBS
	LD	E,C
	CALL	FREEMOB
	POP	BC
	INC	C
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	CSEG
	PUBLIC	TURNON
	EXTRN	VDPPAGE,HMMM,VDPSYNC,ENASCR

TURNON:	LD	A,TILPAGE+1
	CALL	T.AUX			;MAKE SHADOW TILPAGE EQUAL TO TILPAGE
	LD	A,BAKPAGE
	CALL	T.AUX			;MAKE BACKGROUND PAGE EQUAL TO TILPAGE
...
T.AUX:	LD	(ACPAGE),A		;COPY A FULL PAGE
	LD	HL,0
	LD	DE,0
	LD	BC,0FFD8H
	LD	A,TILPAGE
