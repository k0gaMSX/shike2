...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	PUBLIC	CHARSDAT,DOORSDAT,CAMDAT,GLOBEDEF,WHITEDEF,FONTSPR,OBJDAT
...
CAMDAT:	DB	-1
OBJDAT:	DS	NR_OBJECTS*SIZOINFO


GLOBEDEF:
	DB	000H,0FFH,080H,080H,080H,080H,080H,080H
	DB	080H,080H,080H,080H,080H,080H,0FFH,000H
	...
	DB 	000H,0FFH,000H,000H,000H,000H,000H,000H
	DB	000H,000H,000H,000H,000H,000H,0FFH,000H
	DB	000H,0FFH,001H,001H,001H,001H,001H,001H
	DB	001H,001H,001H,001H,001H,001H,0FFH,000H


WHITEDEF:
	DB	000H,0FFH,07FH,0FFH,0FFH,0FFH,0FFH,0FFH
	...
	DB	0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,000H
	DB	000H,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH,0FFH
	DB	0FFH,0FFH,0FFH,0FFH,0FEH,0FFH,0FFH,000H
